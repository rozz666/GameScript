...
{
    MOCK_METHOD3(createCallMethod, SharedIStatement(unsigned, const std::string&, const gs::ObjectIndices& ));
    MOCK_METHOD1(createReturn, SharedIStatement(SharedIExpression));
};
